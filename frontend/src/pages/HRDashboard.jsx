  ...
  return (
    <div className="min-h-screen bg-stone-50">
      ...
      <header className="bg-stone-50 shadow">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-3xl font-bold text-stone-900">HR Manager Dashboard</h1>
              <p className="text-stone-600 mt-1">Welcome back, {user?.name || user?.email}!</p>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <button
              ...
              className="bg-stone-50 p-6 rounded-lg shadow hover:shadow-md transition text-left"
            >
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <h3 className="font-semibold text-stone-900">Book a Meeting Room</h3>
                  <p className="text-sm text-stone-600">Schedule a new meeting</p>
                </div>
              </div>
            </button>
            ...
            >
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <h3 className="font-semibold text-stone-900">View My Bookings</h3>
                  <p className="text-sm text-stone-600">Manage your reservations</p>
                </div>
              </div>
            </button>
          </div>
        ...
        <div className="mb-8">
          <h2 className="text-xl font-semibold text-stone-900 mb-4">My Statistics</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-stone-50 p-6 rounded-lg shadow">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-stone-600">My Total Bookings</p>
                  <p className="text-3xl font-bold text-stone-900 mt-2">{stats.myBookings}</p>
                </div>
            ...
            <div className="bg-stone-50 p-6 rounded-lg shadow">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-stone-600">Upcoming Meetings</p>
                  <p className="text-3xl font-bold text-stone-900 mt-2">{stats.upcomingBookings}</p>
                </div>
                <div className="bg-amber-100 p-3 rounded-full">
                  <svg className="w-8 h-8 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-stone-50 p-6 rounded-lg shadow">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-stone-600">Available Rooms</p>
                  <p className="text-3xl font-bold text-stone-900 mt-2">{stats.totalRooms}</p>
                </div>
                <div className="bg-amber-100 p-3 rounded-full">
                  <svg className="w-8 h-8 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mb-8">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-xl font-semibold text-stone-900">Available Rooms & Components</h2>
            <button
              onClick={() => navigate('/bookings')}
            ...
            {availableRooms.length === 0 ? (
              ...
              <div className="divide-y divide-stone-200">
                {availableRooms.map((room) => (
                  <div key={room._id} className="p-6 hover:bg-stone-50 transition">
                        ...
                        <div className="flex items-center">
                          ...
                          <div>
                            ...
                            {room.components && room.components.length > 0 && (
                              <div className="mt-3">
                                <p className="text-sm font-medium text-stone-700 mb-2">Components:</p>
                            ...
                            {(!room.components || room.components.length === 0) && (
                              <p className="text-sm text-stone-500 mt-2">No components available</p>
                            )}
                          </div>
                        </div>
                      </div>
        ...
        <div>
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-xl font-semibold text-stone-900">My Bookings</h2>
            <button
              onClick={() => navigate('/bookings')}
              className="text-amber-600 hover:text-amber-800 font-medium"
            >
            ...
            {upcomingBookings.length === 0 ? (
              ...
              <div className="divide-y divide-stone-200">
                {upcomingBookings.map((booking) => (
                  <div key={booking._id} className="p-6 hover:bg-stone-50 transition">
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        <div className="flex items-center">
                          <div className="bg-amber-100 p-2 rounded-lg mr-4">
