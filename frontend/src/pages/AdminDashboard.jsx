  ...
  return (
    <div className="min-h-screen bg-stone-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-amber-100 mt-1">System Overview & Management</p>
            </div>
            <div className="flex items-center space-x-4">
              <span className="px-3 py-1 bg-amber-400 text-stone-900 rounded-full text-sm font-bold">
                Administrator
              </span>
              <button
                onClick={handleLogout}
                className="px-4 py-2 bg-stone-50 text-amber-600 rounded-lg hover:bg-amber-50 transition font-medium"
              >
                Logout
              </button>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Admin Quick Actions */}
        <div className="mb-8">
          <h2 className="text-xl font-semibold text-stone-900 mb-4">Admin Controls</h2>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <button
              ...
              className="bg-stone-50 p-6 rounded-lg shadow hover:shadow-lg transition text-left border-l-4 border-amber-500"
            >
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  <h3 className="font-semibold text-stone-900">Add Room</h3>
                  <p className="text-xs text-stone-600">Create new room</p>
                </div>
              </div>
            </button>
            ...
            >
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  <h3 className="font-semibold text-stone-900">Add Floor</h3>
                  <p className="text-xs text-stone-600">Create new floor</p>
                </div>
              </div>
            </button>
            ...
            >
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  <h3 className="font-semibold text-stone-900">Add Component</h3>
                  <p className="text-xs text-stone-600">Create new component</p>
                </div>
              </div>
            </button>
            ...
            >
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  <h3 className="font-semibold text-stone-900">Reports</h3>
                  <p className="text-xs text-stone-600">Analytics & insights</p>
                </div>
              </div>
            </button>
          </div>
        ...
        {/* Stats Cards */}
        <div className="mb-8">
          <h2 className="text-xl font-semibold text-stone-900 mb-4">System Overview</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4">
            <div className="bg-stone-50 p-4 rounded-lg shadow">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs text-stone-600">Total Bookings</p>
            ...
            <div className="bg-stone-50 p-4 rounded-lg shadow">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs text-stone-600">Active Now</p>
                  <p className="text-2xl font-bold text-amber-600 mt-1">{stats.activeBookings}</p>
                </div>
                <div className="bg-amber-100 p-2 rounded-lg">
                  <svg className="w-6 h-6 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-stone-50 p-4 rounded-lg shadow">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-amber-600 mt-1">{stats.pendingBookings}</p>
                </div>
                <div className="bg-amber-100 p-2 rounded-lg">
                  <svg className="w-6 h-6 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-stone-50 p-4 rounded-lg shadow">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs text-stone-600">Total Rooms</p>
                  <p className="text-2xl font-bold text-amber-600 mt-1">{stats.totalRooms}</p>
                </div>
                <div className="bg-amber-100 p-2 rounded-lg">
                  <svg className="w-6 h-6 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-stone-50 p-4 rounded-lg shadow">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs text-stone-600">Components</p>
                  <p className="text-2xl font-bold text-amber-600 mt-1">{stats.totalComponents}</p>
                </div>
                <div className="bg-amber-100 p-2 rounded-lg">
                  <svg className="w-6 h-6 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-stone-50 p-4 rounded-lg shadow">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs text-stone-600">Floors</p>
                  <p className="text-2xl font-bold text-amber-600 mt-1">{stats.totalFloors}</p>
                </div>
                <div className="bg-amber-100 p-2 rounded-lg">
                  <svg className="w-6 h-6 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mb-8">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-xl font-semibold text-stone-900">Manage Rooms</h2>
          </div>
          <div className="bg-stone-50 rounded-lg shadow overflow-hidden">
            {rooms.length === 0 ? (
              <div className="p-8 text-center text-stone-500">No rooms yet</div>
            ) : (
              <div className="divide-y divide-stone-200">
                {rooms.map((room) => (
                  <div key={room._id} className="p-4 flex items-center justify-between hover:bg-stone-50">
                    <div>
                      <h3 className="font-semibold text-stone-900">{room.name}</h3>
                      <p className="text-sm text-stone-600">Floor {room.floor?.floorNumber || 'N/A'} • Capacity: {room.capacity}</p>
                    </div>
                    <button
        ...
        <div className="mb-8">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-xl font-semibold text-stone-900">Manage Floors</h2>
          </div>
          <div className="bg-stone-50 rounded-lg shadow overflow-hidden">
            {floors.length === 0 ? (
              <div className="p-8 text-center text-stone-500">No floors yet</div>
            ) : (
              <div className="divide-y divide-stone-200">
                {floors.map((floor) => (
                  <div key={floor._id} className="p-4 flex items-center justify-between hover:bg-stone-50">
                    <div>
                      <h3 className="font-semibold text-stone-900">Floor {floor.floorNumber} - {floor.name}</h3>
                      {floor.description && <p className="text-sm text-stone-600">{floor.description}</p>}
                    </div>
                    <button
        ...
        <div className="mb-8">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-xl font-semibold text-stone-900">Manage Components</h2>
          </div>
          <div className="bg-stone-50 rounded-lg shadow overflow-hidden">
            {components.length === 0 ? (
              <div className="p-8 text-center text-stone-500">No components yet</div>
            ) : (
              <div className="divide-y divide-stone-200">
                {components.map((component) => (
                  <div key={component._id} className="p-4 flex items-center justify-between hover:bg-stone-50">
                    <div>
                      <h3 className="font-semibold text-stone-900">{component.name}</h3>
                      <p className="text-sm text-stone-600">{component.type} • Quantity: {component.quantity}</p>
                    </div>
                    <button
                  ...
                  {recentBookings.map((booking) => (
                    <tr key={booking._id} className="hover:bg-stone-50">
                      ...
                      <td className="px-6 py-4">
                        <div className="text-sm text-stone-900 max-w-xs truncate">{booking.purpose}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
        ...
        {showRoomModal && (
          ...
          >
            <div 
              className="bg-stone-50 rounded-lg p-6 w-full max-w-md"
              onClick={(e) => e.stopPropagation()}
            >
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-xl font-bold text-stone-900">Add New Room</h3>
                <button
                  onClick={() => {
                    setShowRoomModal(false);
                    setRoomForm({ name: '', capacity: '', floor: '', description: '' });
              ...
              <form onSubmit={handleCreateRoom} className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-stone-700 mb-1">Floor *</label>
                  <select
        ...
        {showFloorModal && (
          ...
          >
            ...
            >
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-xl font-bold text-stone-900">Add New Floor</h3>
                <button
                  onClick={() => {
                    setShowFloorModal(false);
                    setFloorForm({ floorNumber: '', name: '', description: '' });
              ...
              <form onSubmit={handleCreateFloor} className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-stone-700 mb-1">Floor Number *</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-sm font-medium text-stone-700 mb-1">Floor Name *</label>
                  <input
                    type="text"
        ...
        {showComponentModal && (
          ...
          >
            ...
            >
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-xl font-bold text-stone-900">Add New Component</h3>
                <button
                  onClick={() => {
                    setShowComponentModal(false);
                    setComponentForm({ room: '', type: '', name: '', serialNumber: '', quantity: 1, isWorking: true, notes: '' });
              ...
              <form onSubmit={handleCreateComponent} className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-stone-700 mb-1">Component Name *</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-medium text-stone-700 mb-1">Serial Number</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="flex items-center space-x-2">
                    ...
                    />
                    <span className="text-sm font-medium text-stone-700">Is Working</span>
                  </label>
                </div>
                <div>
